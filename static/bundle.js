...
/***/ function(module, exports) {
	...
	// RLCA
	cbOperations[0x07] = rlcR('a');
	// RLA
	cbOperations[0x17] = rlR('a');
	// RRCA
	cbOperations[0x0F] = rrcR('a');
	// RRA
	cbOperations[0x1F] = rrR('a');
	
	// RLC n
	cbOperations[0x00] = rlcR('b');
	cbOperations[0x01] = rlcR('c');
	cbOperations[0x02] = rlcR('d');
	cbOperations[0x03] = rlcR('e');
	cbOperations[0x04] = rlcR('h');
	cbOperations[0x05] = rlcR('l');
	cbOperations[0x06] = rlcMM('h', 'l');
	
	// RL n
	cbOperations[0x10] = rlR('b');
	cbOperations[0x11] = rlR('c');
	cbOperations[0x12] = rlR('d');
	cbOperations[0x13] = rlR('e');
	cbOperations[0x14] = rlR('h');
	cbOperations[0x15] = rlR('l');
	cbOperations[0x16] = rlMM('h', 'l');
	
	// RRC n
	cbOperations[0x08] = rrcR('b');
	cbOperations[0x09] = rrcR('c');
	cbOperations[0x0A] = rrcR('d');
	cbOperations[0x0B] = rrcR('e');
	cbOperations[0x0C] = rrcR('h');
	cbOperations[0x0D] = rrcR('l');
	cbOperations[0x0E] = rrcMM('h', 'l');
	
	// RR n
	cbOperations[0x18] = rrR('b');
	cbOperations[0x19] = rrR('c');
	cbOperations[0x1A] = rrR('d');
	cbOperations[0x1B] = rrR('e');
	cbOperations[0x1C] = rrR('h');
	cbOperations[0x1D] = rrR('l');
